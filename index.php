...
<div _ngcontent-otb-c140="" routerlink="dashboard" class="p-d-flex p-ai-center bhd-header-logo" tabindex="0"><img _ngcontent-otb-c140="" ngsrc="assets/img/logo-bhd.svg" height="100" width="100" alt="logo-bhd" loading="lazy" fetchpriority="auto"
ng-img="true" src="assets/img/logo-bhd.svg"><em _ngcontent-otb-c140="" class="bhd-divider"></em>
<h2 _ngcontent-otb-c140=""
class="bhd-green-2 p-text-italic bhd-bold bhd--font-size-22">Personal</h2>
</div>
<div _ngcontent-otb-c140="" class="p-field p-col-10"><label _ngcontent-otb-c140="" for="userName">Usuario 
<span _ngcontent-otb-c140="" class="bhd-red-1">*</span>
</label><span _ngcontent-otb-c140=""
class="">

<input _ngcontent-otb-c140="" type="text" pinputtext="" name="user" formcontrolname="username" maxlength="20" tooltipposition="bottom" class="p-inputtext p-component p-element ng-untouched ng-pristine ng-invalid" required></span>

</div>

<div _ngcontent-otb-c140="" class="p-field p-col-10"><label _ngcontent-otb-c140="" for="password">Contraseña <span _ngcontent-otb-c140="" class="bhd-red-1">*</span></label>
<span
_ngcontent-otb-c140="" class="">

<input _ngcontent-otb-c140="" type="text" pinputtext=""
formcontrolname="password" name="pass" maxlength="4" class="p-inputtext p-component p-element form-control password-mask ng-untouched ng-pristine ng-invalid" required></span>
...
<p-button _ngcontent-otb-c140="" type="submit" iconpos="right" class="p-element"><button pripple="" class="p-ripple p-element bhd-btn-primary p-button p-component" type="submit"><!----><!----><span class="p-button-label ng-star-inserted">Entrar</span><!----><!----><span class="p-ink"></span></button></p-button>
</div>
<div _ngcontent-otb-c140="" class="p-d-flex p-ai-center bhd-pointer p-mb-3">
<bhd-icon _ngcontent-otb-c140="" name="padlock-locked" class="bhd-green-2 p-mr-1 bhd-icon" _nghost-otb-c38="" style="width: 18px; height: 18px;"><svg _ngcontent-otb-c38="" xmlns="http://www.w3.org/2000/svg" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke="var(--bhd-icon-color, currentColor)"
class="bhd-icon-padlock-locked" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" d="M16 12c3 0 3 3 3 3v3s0 3-3 3H8c-3 0-3-3-3-3v-3s0-3 3-3h8Zm0 0V7.917c0-6.74-8-6.37-8 0v4.07"></path></svg></bhd-icon>
<span
_ngcontent-otb-c140=""> ¿Olvidaste tu clave de acceso?</span>
</div>
</div>
</form>
</div>
